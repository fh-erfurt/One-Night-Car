...
public class PersonAddress {
     ...
     * @param streetNumber Address street number (With the possibility for Letters)
     */
     ...
     * @param ZIP A String containing the the Address ZIP
     */
    public void setZIP(String ZIP){
        this.ZIP = ZIP;
    }
    /** Sets the Address City.
     * @param city A String containing the the Address ZIP
     */
    public void setCity(String city){
        this.city = city;
    }
    /** Sets the Address Street.
     * @param street A String containing the the Address Street
     */
    public void setStreet(String street){
        this.street = street;
    }
    /** Sets the Address StreetNumber.
     * @param streetNumber A String containing the the Address StreetNumber
     */
